 ...
 * Amalgamated single-file header for RetroDebugger.
 * Original: https://github.com/richgel999/miniz (v2.1.0)
 */
#ifndef MINIZ_AMALGAMATED_H
#define MINIZ_AMALGAMATED_H
