...
void mon_disassembly_init(mon_disassembly_private_t *);
void mon_disassembly_update(mon_disassembly_private_t *);
mon_disassembly_t *mon_disassembly_get_lines(mon_disassembly_private_t *, int lines_visible, int lines_full_visible);
mon_disassembly_t *mon_dump_get_lines(mon_memory_private_t *pmmp, int lines_visible, int lines_full_visible);
void mon_navigate_set_memspace(mon_navigate_private_t *, MEMSPACE);
MEMSPACE mon_navigate_get_memspace(mon_navigate_private_t *);
uint16_t mon_navigate_scroll(mon_navigate_private_t *,
                                MON_SCROLL_TYPE );
uint16_t mon_navigate_scroll_to(mon_navigate_private_t *, uint16_t);
...
void mon_disassembly_determine_popup_commands(mon_disassembly_private_t *, int xPos, int yPos, uint16_t *ulMask, uint16_t *ulDefault);

void mon_disassembly_set_breakpoint(mon_disassembly_private_t *);
void mon_disassembly_unset_breakpoint(mon_disassembly_private_t *);
void mon_disassembly_enable_breakpoint(mon_disassembly_private_t *);
void mon_disassembly_disable_breakpoint(mon_disassembly_private_t *);

void mon_navigate_goto_address(mon_navigate_private_t *, uint16_t addr);
void mon_navigate_goto_pc(mon_navigate_private_t *);
...
void mon_navigate_goto_string(mon_navigate_private_t *, char *addr);

void mon_disassembly_set_next_instruction(mon_disassembly_private_t *pmdp);



void mon_memory_init(mon_memory_private_t *);
void mon_memory_update(mon_memory_private_t *);
mon_memory_t *mon_memory_get_lines(mon_memory_private_t *, int lines_visible, int lines_full_visible);
