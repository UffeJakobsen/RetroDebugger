...
/* joystick_close is defined in joyport/joystick.c (VICE 3.10) */
...
/* joy_arch_mapping_dump is defined in joyport/joystick.c (VICE 3.10) */
#if 0
...
/* joy_arch_mapping_load is defined in joyport/joystick.c (VICE 3.10) */
#if 0
...
/* SDL-specific versions called by joystick.c (VICE 3.10 naming) */
...
{
    /* nothing to do in our embedded build */
}
