...
{
	// Don't do full frame refresh during debug stepping — the atomic refresh
	// in c64d_debug_pause_check() handles screen updates at each pause.
	if (c64d_debug_mode_get() != DEBUGGER_MODE_RUNNING)
	{
		return;
	}
