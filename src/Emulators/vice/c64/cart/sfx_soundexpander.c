...
static int sfx_soundexpander_sound_machine_calculate_samples(sound_t **psid, float *pbuf, int nr, int sound_chip_channels, int *delta_t);
#else
...
#ifdef SOUND_SYSTEM_FLOAT
/* FIXME */
static int sfx_soundexpander_sound_machine_calculate_samples(sound_t **psid, float *pbuf, int nr, int scc, int *delta_t)
{
    int i;
    int16_t *buffer;
