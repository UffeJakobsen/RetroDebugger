...
static int magicvoice_sound_machine_calculate_samples(sound_t **psid, float *pbuf, int nr, int sound_chip_channels, int *delta_t);
#else
...
#ifdef SOUND_SYSTEM_FLOAT
/* FIXME */
static int magicvoice_sound_machine_calculate_samples(sound_t **psid, float *pbuf, int nr, int scc, int *delta_t)
{
    int i;
    float *buffer;
