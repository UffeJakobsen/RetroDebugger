...
int c64_snapshot_read_from_memory(int save_chips, int read_roms, int read_disks, int event_mode, int read_reu_data, int read_cart_roms,
										 unsigned char *snapshot_data, int snapshot_size);
int c64_snapshot_write_in_memory(int save_chips, int save_roms, int save_disks, int event_mode,
