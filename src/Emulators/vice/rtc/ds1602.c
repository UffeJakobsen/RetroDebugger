...
/* RTC_DS12C887 snapshot module format:
   ...
   uint32_t  | offset 0 hi   | high uint32_t of RTC offset 0
   uint32_t  | offset 0 lo   | low uint32_t of RTC offset 0
   ...
   uint32_t  | reg           | current register
   uint8_t   | state         | current state
   uint8_t   | bit           | current bit
   uint8_t   | io byte       | current I/O uint8_t
   uint8_t   | rst           | RST line state
   uint8_t   | clk           | CLK line state
   uint8_t   | data line in  | DATA in line state
   uint8_t   | data line out | DATA out line state
