...
/* ARCHDEP_MOUSE_ENABLE_DEFAULT: fallback if not provided by archdep.h */
#ifndef ARCHDEP_MOUSE_ENABLE_DEFAULT
...
int set_mouse_enabled(int new_state, void *param)
{
...
/* c64d: mouse type control for debugger */
void c64d_mouse_set_type(int mt)
{
    mouse_type = mt;
}

/* c64d: map mouse type to joyport device ID */
int c64d_mouse_type_to_joyportid(int mouseType)
{
    switch (mouseType) {
        case MOUSE_TYPE_1351:    return JOYPORT_ID_MOUSE_1351;
        case MOUSE_TYPE_NEOS:    return JOYPORT_ID_MOUSE_NEOS;
        case MOUSE_TYPE_AMIGA:   return JOYPORT_ID_MOUSE_AMIGA;
        case MOUSE_TYPE_CX22:    return JOYPORT_ID_MOUSE_CX22;
        case MOUSE_TYPE_ST:      return JOYPORT_ID_MOUSE_ST;
        case MOUSE_TYPE_SMART:   return JOYPORT_ID_MOUSE_SMART;
        case MOUSE_TYPE_MICROMYS: return JOYPORT_ID_MOUSE_MICROMYS;
        case MOUSE_TYPE_KOALAPAD: return JOYPORT_ID_KOALAPAD;
        case MOUSE_TYPE_PADDLE:  return JOYPORT_ID_PADDLES;
        default:                 return JOYPORT_ID_MOUSE_1351;
    }
}
