...
void fdc_init(struct drive_context_s *drv);
void fdc_reset(unsigned int fnum, unsigned int enabled);

int fdc_snapshot_read_module(struct snapshot_s *s, int drv);
int fdc_snapshot_write_module(struct snapshot_s *s, int drv);

int fdc_attach_image(struct disk_image_s *image, unsigned int unit);
int fdc_detach_image(struct disk_image_s *image, unsigned int unit);
