...
int iec_drive_snapshot_read(struct drive_context_s *ctxptr, struct snapshot_s *s);
int iec_drive_snapshot_write(struct drive_context_s *ctxptr, struct snapshot_s *s);
