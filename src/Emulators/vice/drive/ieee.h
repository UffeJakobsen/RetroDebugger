...
int ieee_drive_snapshot_write(struct drive_context_s *ctxptr,
                                     struct snapshot_s *s);
int ieee_drive_image_attach(struct disk_image_s *image,
                                   unsigned int unit);
int ieee_drive_image_detach(struct disk_image_s *image,
                                   unsigned int unit);

void ieee_drive_parallel_set_atn(int state, struct drive_context_s *drv);
