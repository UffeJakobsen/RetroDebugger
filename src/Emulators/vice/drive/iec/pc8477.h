...
void pc8477d_init(struct drive_context_s *drv);
void pc8477_shutdown(pc8477_t *drv);

void pc8477_setup_context(struct drive_context_s *drv);
void pc8477d_store(struct drive_context_s *drv, uint16_t addr, uint8_t byte);
uint8_t pc8477d_read(struct drive_context_s *drv, uint16_t addr);
uint8_t pc8477d_peek(struct drive_context_s *drv, uint16_t addr);
