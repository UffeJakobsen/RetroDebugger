...
void wd1770d_init(struct drive_context_s *drv);
...
void wd1770d_store(struct drive_context_s *drv, uint16_t addr, uint8_t byte);
uint8_t wd1770d_read(struct drive_context_s *drv, uint16_t addr);
uint8_t wd1770d_peek(struct drive_context_s *drv, uint16_t addr);
