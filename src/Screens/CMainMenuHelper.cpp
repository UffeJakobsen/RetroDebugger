...
void CMainMenuHelper::OpenDialogInsertD64()
{
...
void CMainMenuHelper::OpenDialogInsertATR()
{
...
void CMainMenuHelper::OpenDialogInsertCartridge()
{
...
void CMainMenuHelper::OpenDialogInsertAtariCartridge()
{
	LOGM("OpenDialogInsertCartridge");
...
void CMainMenuHelper::OpenDialogInsertTape()
{
...
void CMainMenuHelper::OpenDialogAttachReu()
{
...
void CMainMenuHelper::OpenDialogSaveReu()
{
...
void CMainMenuHelper::SystemDialogFileOpenSelected(CSlrString *path)
{
...
void CMainMenuHelper::SystemDialogFileSaveCancelled()
{
}

// TODO: refactor and move me to.... / in progress make a generic file opener
void CMainMenuHelper::LoadFile(CSlrString *path)
{
...
bool CMainMenuHelper::InsertD64(CSlrString *path, bool updatePathToD64, bool autoRun, int autoRunEntryNum, bool showLoadAddressInfo)
{
...
void CMainMenuHelper::InsertNextD64()
{
...
bool CMainMenuHelper::AttachReu(CSlrString *path, bool updatePathToReu, bool showDetails)
{
...
bool CMainMenuHelper::SaveReu(CSlrString *path, bool updatePathToReu, bool showDetails)
{
...
bool CMainMenuHelper::InsertCartridge(CSlrString *path, bool updatePathToCRT)
{
...
bool CMainMenuHelper::LoadPRG(CSlrString *path, bool autoStart, bool updatePRGFolderPath, bool showAddressInfo, bool forceFastReset)
{
...
bool CMainMenuHelper::LoadSID(CSlrString *filePath)
{
...
bool CMainMenuHelper::LoadTape(CSlrString *path, bool autoStart, bool updateTAPFolderPath, bool showAddressInfo)
{
...
bool CMainMenuHelper::LoadXEX(CSlrString *path, bool autoStart, bool updateXEXFolderPath, bool showAddressInfo)
{
...
bool CMainMenuHelper::LoadCAS(CSlrString *path, bool autoStart, bool updateCASFolderPath, bool showAddressInfo)
{
...
bool CMainMenuHelper::InsertAtariCartridge(CSlrString *path, bool autoStart, bool updateAtariCartridgeFolderPath, bool showAddressInfo)
{
...
//
bool CMainMenuHelper::InsertATR(CSlrString *path, bool updatePathToATR, bool autoRun, int autoRunEntryNum, bool showLoadAddressInfo)
{
...
bool CMainMenuHelper::LoadASAP(CSlrString *filePath)
{
...
bool CMainMenuHelper::LoadNES(CSlrString *path, bool updateNESFolderPath)
{
	if (path == NULL)
		return false;
...
void CMainMenuHelper::LoadLabelsAndWatches(CSlrString *path, CDebugInterface *debugInterface)
{
...
bool CMainMenuHelper::LoadPRG(CByteBuffer *byteBuffer, bool autoStart, bool showAddressInfo, bool forceFastReset)
{
	if (viewC64->debugInterfaceC64 == NULL)
		return false;
...
void CMainMenuHelper::ThreadRun(void *data)
{
...
void CMainMenuHelper::SetupC64Defaults()
{
	// TODO: c64 MODEL
	...
	viewC64->debugInterfaceC64->SetReuEnabled(c64SettingsReuEnabled);
	viewC64->debugInterfaceC64->SetReuSize(c64SettingsReuSize);
...
bool CMainMenuHelper::LoadPRGNotThreaded(CByteBuffer *byteBuffer, bool autoStart, bool showAddressInfo)
{
...
void CMainMenuHelper::LoadPRG(CByteBuffer *byteBuffer, u16 *startAddr, u16 *endAddr)
{
...
void CMainMenuHelper::ResetAndJSR(int startAddr)
{
	viewC64->debugInterfaceC64->ResetSoft();
	viewC64->debugInterfaceC64->MakeJsrC64(startAddr);
...
void CMainMenuHelper::ReloadAndRestartPRG()
{
...
{
	viewC64->mainMenuHelper->font->BlitTextColor(str, px, py, pz,
												  viewC64->mainMenuHelper->fontScale, r, g, b, 1);

	if (shortcut != NULL && shortcut->str != NULL)
	{
		viewC64->mainMenuHelper->font->BlitTextColor(shortcut->str, px + 510, py, pz,
													  viewC64->mainMenuHelper->fontScale,
	...
	if (str2 != NULL)
	{
		py += viewC64->mainMenuHelper->fontHeight;
		viewC64->mainMenuHelper->font->BlitTextColor(str2, px, py, pz,
													  viewC64->mainMenuHelper->fontScale, r, g, b, 1);
	}
}
