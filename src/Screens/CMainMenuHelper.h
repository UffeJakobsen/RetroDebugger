...
class CMainMenuHelper : public CGuiView, CGuiButtonCallback, CGuiViewMenuCallback, CSystemFileDialogCallback, CSlrThread, CSlrKeyboardShortcutCallback, CUiMessageBoxCallback
{
public:
	CMainMenuHelper(float posX, float posY, float posZ, float sizeX, float sizeY);
	virtual ~CMainMenuHelper();
